...
# Import database
setwd("~/DAIRYdb_v1.2.0_20190222/DAIRYdb_v1.2.0_20190222_IDTAXA/")
# import training sequences
dna <- readDNAStringSet("DAIRYdb_v1.2.0_20190222_IDTAXA.fasta")
...
wd = "DAIRYdb_v1.2.0_20190222_IDTAXA"
